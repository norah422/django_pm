...
class Task_creat_view(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    model = models.Task
...
class Task_update_view(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = models.Task
    fields = ['is_completed']
    http_method_names = ['post']
...
class Task_delete_view(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = models.Task
